...
function renderModalTags(){
  ...
  modalTags.forEach((t,i)=>{const c=tagColor(t);const span=document.createElement('span');span.className='tag';span.style.background=c.bg;span.style.color=c.fg;
...
function openAddModal(){
  ...
  document.getElementById('mFront').value='';document.getElementById('mDeck').value='';document.getElementById('mTagInput').value='';
...
function editCard(id){
  ...
  document.getElementById('mFront').value=c.front;document.getElementById('mDeck').value=c.deck||'';document.getElementById('mTagInput').value='';
...
function importCards(){
  ...
  try{const arr=JSON.parse(raw);if(!Array.isArray(arr))throw new Error('Must be an array');
